          ...
          components={{
            ...
            code: ({inline, children}) => 
              inline 
                ...
                : <pre className="bg-muted p-3 rounded-lg text-xs font-mono overflow-x-auto text-foreground my-2"><code>{children}</code></pre>,
            blockquote: ({children}) => <blockquote className="border-l-4 border-primary pl-4 text-sm text-muted-foreground my-2">{children}</blockquote>,
